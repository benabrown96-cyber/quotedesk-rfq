...
:root {
  ...
  --card-border: 36 16% 88%;
  --sidebar: 222 24% 15%;
  --sidebar-foreground: 40 29% 96%;
  --sidebar-border: 222 18% 22%;
  --sidebar-primary: 33 74% 36%;
  --sidebar-primary-foreground: 0 0% 100%;
  --sidebar-accent: 222 18% 22%;
  --sidebar-accent-foreground: 40 29% 96%;
  --sidebar-ring: 33 74% 36%;
  --popover: 40 31% 98%;
  --popover-foreground: 222 24% 14%;
  --popover-border: 36 16% 86%;
  --primary: 33 74% 36%;
  --primary-foreground: 0 0% 98%;
  --secondary: 38 18% 90%;
  --secondary-foreground: 222 24% 16%;
  --muted: 38 18% 91%;
  --muted-foreground: 219 11% 40%;
  --accent: 37 24% 88%;
  --accent-foreground: 222 24% 14%;
  --destructive: 352 68% 40%;
  ...
  --chart-4: 43 74% 49%;
  --chart-5: 352 58% 46%;
  --font-sans: Satoshi, "General Sans", sans-serif;
...
.dark {
  ...
  --border: 222 18% 20%;
  --card: 222 24% 11%;
  --card-foreground: 38 20% 89%;
  --card-border: 222 18% 17%;
  --sidebar: 222 26% 7%;
  --sidebar-foreground: 38 20% 89%;
  --sidebar-border: 222 18% 16%;
  --sidebar-primary: 35 88% 58%;
  --sidebar-primary-foreground: 222 24% 8%;
  --sidebar-accent: 222 18% 16%;
  --sidebar-accent-foreground: 38 20% 89%;
  --sidebar-ring: 35 88% 58%;
  --popover: 222 24% 12%;
  --popover-foreground: 38 20% 89%;
  --popover-border: 222 18% 19%;
  --primary: 35 88% 58%;
  --primary-foreground: 222 24% 8%;
  --secondary: 222 17% 18%;
  --secondary-foreground: 38 20% 89%;
  --muted: 222 17% 18%;
  --muted-foreground: 38 9% 65%;
  --accent: 222 17% 20%;
  --accent-foreground: 38 20% 89%;
  --destructive: 352 72% 58%;
  --destructive-foreground: 0 0% 98%;
  --input: 222 14% 30%;
  --ring: 35 88% 58%;
  --chart-1: 35 88% 58%;
